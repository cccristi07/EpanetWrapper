...
\input{\chapters/scenarii de lucru si calcul reziduuri} % de aici aleg ce features sa folosesc mai departe
\input{\chapter/Detectia si izolarea defectelor} % sensor selection, dict learning, classification, perf
% problema de optimiare MSC MTC ^
\input{\chapters/Exemplu de mari dimensiuni} % pe reteaua de apa din Barcelona
\input{\chapters/Concluzii si directii viitoare} % 1 pag
% blbiliografie 1-2pag
% appendix 5-6pag tot ce mi se pare mie relevant
